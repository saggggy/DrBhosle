...
const Carrior = () => {
    return (
            ...
            <div className="container-fluid p-0 bgcolor">
                <div className='text-center py-3 hee shadow text-light'>
                    <h1>Courses in KP Astrology</h1>
                </div>
                
                <div className="container py-5">
                <div className="row section_our_solution ">     
                             ...
                             <div className="row">
                              <div className="col-12 col-md-6 py-3">
                                    <div className="solution_card">
                                        ...
                                        <h3 className='fw-bold'>Shastri Pandit Mahapandit</h3>
                                        </div>
                                        <div className="solu_description">
                                        <p>
                                        A unified course in Shastri, Pandit and Mahapandit to cultivate profound spiritual and scholarly expertise
                                        </p>
                                        <button type="button" className="read_more_btn">
                                        <Link to="/front" className='text-decoration-none text-black'>Apply Now</Link>
                                        </button>
                                        </div>
                                    </div>
                              </div>
                              <div className="col-12 col-md-6 py-3">
                                    <div className="solution_card">
                                        ...
                                        <div className="solu_title">
                                        <h3 className='fw-bold'>Vidyavachaspati </h3>
                                        </div>
                                        <div className="solu_description">
                                        <p>
                                        An elite program aimed at cultivating expertise in Vedic philosophy, language and literature, designed for those aspiring to excel in scholarly pursuits.
                                        </p>
                                        <button type="button" className="read_more_btn">
                                        <Link to="/front" className='text-decoration-none text-black'>Apply Now</Link>
                                        </button>
